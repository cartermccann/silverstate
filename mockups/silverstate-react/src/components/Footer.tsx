    ...
    <footer role="contentinfo" style={{ paddingTop: 64, paddingBottom: 32, borderTop: '1px solid var(--border)', color: 'var(--muted)', fontSize: '.85rem' }}>
      <div className="wrap">
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 32 }} className="footer-grid">
          ...
          <div>
            <h4 style={{ fontFamily: 'var(--font-display)', fontSize: '.7rem', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--text)', marginBottom: 12, fontWeight: 600, textWrap: 'balance' }}>Programs</h4>
          ...
          <div>
            <h4 style={{ fontFamily: 'var(--font-display)', fontSize: '.7rem', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--text)', marginBottom: 12, fontWeight: 600, textWrap: 'balance' }}>Admissions</h4>
            <ul style={{ listStyle: 'none', padding: 0 }}>
          ...
          <div>
            <h4 style={{ fontFamily: 'var(--font-display)', fontSize: '.7rem', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--text)', marginBottom: 12, fontWeight: 600, textWrap: 'balance' }}>About</h4>
            <ul style={{ listStyle: 'none', padding: 0 }}>
