...
export const insuranceProviders: InsurancePageData[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes, Aetna typically requires pre-authorization for residential treatment. Silver State manages the entire pre-authorization process for families, submitting clinical documentation and coordinating directly with Aetna on your behalf.',
      },
      {
        q: 'How long does insurance verification take with Aetna?',
        a: 'Silver State can usually verify Aetna benefits within 10 minutes over the phone. We check your specific plan details, including coverage levels for residential treatment and therapy services, so you know what to expect before beginning the admissions process.',
      },
    ],
    metaDescription:
      'Aetna covers adolescent mental health treatment at Silver State in Las Vegas. Verify teen residential behavioral health benefits and pre-authorization.',
  },
  {
    slug: 'cigna',
    name: 'Cigna',
    ...
    coverageDescription:
      'Cigna provides comprehensive behavioral health coverage for adolescents through most of its plan options. Under the Mental Health Parity and Addiction Equity Act, Cigna is required to cover mental health and substance use disorder services at levels comparable to medical and surgical benefits, making adolescent treatment more accessible for families.\n\nCigna plans typically cover residential treatment for adolescents when clinical necessity is documented. Cigna utilizes Evernorth Behavioral Health (formerly Cigna Behavioral Health) to manage its mental health benefits, and coverage specifics depend on your individual plan.\n\nSilver State has experience working with Cigna and Evernorth to secure treatment authorization. Our admissions team can verify your Cigna benefits and walk you through what your plan covers for adolescent behavioral health treatment.',
    preAuthorization:
      'Cigna typically requires pre-authorization through Evernorth Behavioral Health for residential adolescent treatment. The process involves submitting a clinical assessment and treatment recommendation demonstrating medical necessity. Silver State coordinates the entire authorization process with Cigna on behalf of families, ensuring all clinical documentation is properly submitted. Contact our admissions team to begin verification.',
    faqs: [
      {
      ...
      {
        q: 'How much does Cigna cover for adolescent residential treatment?',
        a: 'Cigna coverage for adolescent residential treatment varies by plan. Most plans cover a significant portion of residential treatment costs when medically necessary, subject to your deductible and coinsurance. Silver State can provide a detailed breakdown of your specific Cigna benefits when you call.',
      },
      {
    ...
    metaDescription:
      'Cigna covers adolescent mental health treatment at Silver State in Las Vegas. Verify teen residential behavioral health benefits and pre-authorization.',
  },
  {
    slug: 'ambetter',
    name: 'Ambetter',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Silver State works with Ambetter plans for adolescent behavioral health coverage. Contact our admissions team to verify your specific plan details and coverage levels for residential treatment.',
      },
    ],
    metaDescription:
      'Ambetter Marketplace covers adolescent mental health treatment at Silver State in Las Vegas. Verify residential behavioral health benefits for your teen.',
  },
  {
    slug: 'uhc',
    ...
    faqs: [
      ...
      {
        q: 'How much does UHC cover for adolescent residential treatment?',
        a: 'UHC coverage for adolescent residential treatment varies by plan type and network status. Most plans cover residential care when medically necessary, subject to your deductible and coinsurance. Call Silver State for a specific benefits breakdown.',
      },
      {
    ...
    metaDescription:
      'United Healthcare adolescent treatment coverage at Silver State in Las Vegas. Verify residential behavioral health benefits and insurance authorization.',
  },
  {
    slug: 'hpn',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes, HPN typically requires pre-authorization for residential treatment. Silver State handles the entire authorization process, coordinating with HPN to secure approval before your teen begins treatment.',
      },
      {
      ...
      },
      {
        ...
        a: "Silver State works with Health Plan of Nevada for adolescent behavioral health coverage. Contact our admissions team to verify your specific plan's network status and coverage levels for residential treatment.",
      },
    ],
    metaDescription:
      'Health Plan of Nevada adolescent treatment coverage at Silver State in Las Vegas. Verify teen residential behavioral health benefits and authorization.',
  },
  {
    slug: 'medicaid-ffs',
    ...
    metaDescription:
      'Medicaid Fee for Service adolescent treatment at Silver State in Las Vegas. We accept Nevada Medicaid FFS for residential care. Verify benefits today.',
  },
  {
    slug: 'geha',
    name: 'GEHA',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes, GEHA typically requires pre-authorization for residential treatment. Silver State handles the entire authorization process, coordinating with GEHA to secure approval before your teen begins treatment.',
      },
      {
    ...
    metaDescription:
      'GEHA federal employee adolescent treatment coverage at Silver State in Las Vegas. Verify your teen residential behavioral health benefits and authorization.',
  },
  {
    slug: 'umr',
    name: 'UMR',
