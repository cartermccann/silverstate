...
export const locations: LocationData[] = [
  {
    ...
    relatedConditions: ['anxiety', 'depression', 'substance-abuse', 'dual-diagnosis', 'trauma-ptsd'],
  ...
  },
  {
    ...
    metaDescription:
      'Silver State serves Henderson, NV families with adolescent residential, PHP & IOP treatment. Located just 20-25 minutes away in Las Vegas. Call (725) 525-9897.',
  },
  {
    ...
    serviceAreaDescription:
      'Silver State offers North Las Vegas families a full range of adolescent treatment options. Our residential program provides 24/7 care, while PHP and IOP programs allow teens to transition back to their North Las Vegas community with ongoing support.',
    relatedPrograms: ['residential', 'php', 'iop'],
    relatedConditions: ['anxiety', 'depression', 'substance-abuse', 'conduct-disorder'],
    metaTitle: 'Adolescent Treatment Near North Las Vegas, NV | Silver State Treatment',
    metaDescription:
      'Silver State serves North Las Vegas, NV families with teen residential, PHP & IOP treatment. Located approximately 25-30 minutes away. Call (725) 525-9897.',
  },
  {
    name: 'Summerlin',
    slug: 'summerlin',
    ...
    metaTitle: 'Teen Treatment Near Summerlin, NV | Silver State Adolescent Treatment',
    metaDescription:
      'Silver State serves Summerlin, NV families with adolescent residential, PHP & IOP treatment. Just 15-20 minutes away in Las Vegas. Call (725) 525-9897.',
  },
  {
    name: 'Clark County',
    slug: 'clark-county',
    ...
    relatedPrograms: ['residential', 'php', 'iop'],
    relatedConditions: ['anxiety', 'depression', 'substance-abuse', 'dual-diagnosis', 'trauma-ptsd'],
    metaTitle: 'Adolescent Treatment in Clark County, NV | Silver State Treatment Center',
    metaDescription:
      'Silver State serves all of Clark County, NV with adolescent residential, PHP & IOP treatment for teens 11-17. Located in Las Vegas. Call (725) 525-9897.',
  },
]
