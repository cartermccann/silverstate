...
const condition = getConditionBySlug('conduct-disorder-treatment')!
...
export const handle = {
  breadcrumb: { label: 'Conduct Disorder Treatment', parent: '/conditions' },
}

export default function ConductDisorder() {
  useEffect(() => {
